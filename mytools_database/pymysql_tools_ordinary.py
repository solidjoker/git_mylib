...
- func:
    ...
    3. def execute_sql(db=None, sql=None, params=None, many=None, exception_warning=None):
...
def get_databases(exception_warning=None):
    ...
    """
    sql = 'SHOW DATABASES'
    result =execute_sql(sql=sql, exception_warning=exception_warning)
    if result == False:
        return False
